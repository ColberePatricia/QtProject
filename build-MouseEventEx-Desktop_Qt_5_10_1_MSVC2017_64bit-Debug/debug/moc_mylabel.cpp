...
#include "../../MouseEventEx/mylabel.h"
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::Mouse_Pressed)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            typedef void (MyLabel::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::Mouse_Left)) {
                *result = 2;
                return;
            }
        }
