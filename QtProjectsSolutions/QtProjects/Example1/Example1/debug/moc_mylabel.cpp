...
QT_MOC_LITERAL(3, 23, 9), // "Mouse_Pos"
QT_MOC_LITERAL(4, 33, 10) // "Mouse_Left"

    },
    "MyLabel\0Mouse_Pressed\0\0Mouse_Pos\0"
    "Mouse_Left"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::Mouse_Pressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::Mouse_Pos)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::Mouse_Left)) {
                *result = 2;
                return;
            }
        }
