...
void SceneBasic::initScene()
{
   ...
   // Create the fragment shader object
    ...
    // add your model transformations here
    // EXERCISE 4
    // model *= glm::rotate(mat4(1.0f),(-3.14159f/6.0f),vec3(1.0f,0.0f,0.0f)); //A
    // model *= glm::rotate(mat4(1.0f),(3.14159f/6.0f),vec3(0.0f,1.0f,0.0f)); //B
    // model *= glm::rotate(mat4(1.0f),(3.14159f),vec3(1.0f,1.0f,1.0f)); //C
    // model *= glm::rotate(mat4(1.0f),(-3.14159f/6.0f),vec3(1.0f,0.0f,0.0f)); //D
    // model *= glm::rotate(mat4(1.0f),(3.14159f/6.0f),vec3(0.0f,1.0f,0.0f));
    // model *= glm::rotate(mat4(1.0f),(-3.14159f/6.0f),vec3(1.0f,0.0f,0.0f)); //E
    // model *= glm::rotate(mat4(1.0f),(3.14159f/6.0f),vec3(0.0f,1.0f,0.0f));
    // model *= glm::scale(mat4(1.0f),vec3(1.0f,0.5f,1.0f));
    // model *= glm::rotate(mat4(1.0f),(-3.14159f/6.0f),vec3(1.0f,0.0f,0.0f)); //F
    // model *= glm::rotate(mat4(1.0f),(3.14159f/6.0f),vec3(0.0f,1.0f,0.0f));
    // model *= glm::scale(mat4(1.0f),vec3(1.0f,0.5f,1.0f));
    // model *= glm::translate(mat4(1.0f), vec3(0.25f, 0.0f, -1.0f));

 
	// view matrix
    view = glm::lookAt(vec3(0.0f,0.0f,2.0f), vec3(0.0f,0.0f,0.0f), vec3(0.0f,1.0f,0.0f));
    // EXERCISE 4
    // view = glm::lookAt(vec3(1.0f,1.0f,1.0f), vec3(0.0f,0.0f,0.0f), vec3(0.0f,1.0f,0.0f)); //A
    // view = glm::lookAt(vec3(-1.0f,-1.0f,-1.0f), vec3(0.0f,0.0f,0.0f), vec3(0.0f,1.0f,0.0f)); //B
